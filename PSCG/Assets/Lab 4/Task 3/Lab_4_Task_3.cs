...
namespace PSCG.Labs
{
    public sealed class Lab_4_Task_3 : TaskBase
    {
        ...
        protected override IEnumerator Simulation()
        {
            ...
            while (true)
            {
                ...
                CurrentAcceleration = StartAcceleration + A + (B * TimeInSecond);
                CurrentSpeed = StartSpeedUnitInSecond + (CurrentAcceleration * TimeInSecond);
                ...
                PathInUnit = (StartSpeedUnitInSecond * TimeInSecond +
                    CurrentAcceleration * Mathf.Pow(TimeInSecond, 2)).magnitude;
            }
        }
    }
}
